...
[![](https://img.shields.io/github/v/release/Taha-Alavi/3x-ui.svg)](https://github.com/Taha-Alavi/3x-ui/releases)
[![](https://img.shields.io/github/actions/workflow/status/Taha-Alavi/3x-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/Taha-Alavi/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/Taha-Alavi/3x-ui/total.svg)](#)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/Taha-Alavi/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/Taha-Alavi/3x-ui/master/install.sh) v1.6.1
```
...
wget https://github.com/Taha-Alavi/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. Clone the Project Repository:
   ...
   ```sh
   git clone https://github.com/Taha-Alavi/3x-ui.git
   cd 3x-ui
   ```
...
3. Start the Service
   ...
   docker run -itd \
      ...
      --name 3x-ui \
      ghcr.io/Taha-Alavi/3x-ui:latest
   ```
...
[![Stargazers over time](https://starchart.cc/Taha-Alavi/3x-ui.svg)](https://starchart.cc/Taha-Alavi/3x-ui)
